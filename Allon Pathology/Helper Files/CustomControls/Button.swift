...
class Button: UIButton {
    ...
    init(text: String, textColor: UIColor , font: UIFont , cornerRadious: Int , bgColor : UIColor) {
        ...
        self.titleLabel?.font = UIFont(name: (font.fontName), size: CGFloat(Int(font.pointSize).autoSized))
        self.layer.cornerRadius = cornerRadious.autoSized
        self.cornerRadious = cornerRadious.autoSized
        initGradiant()
    }
